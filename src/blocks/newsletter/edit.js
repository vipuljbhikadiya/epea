...
class Edit extends Component {
	...
	render() {
		...
		return (
			<>
				<InspectorControls>
					<PanelBody title={__("General", "epea-theme")} initialOpen={true}>
						<ToggleGroupControl
							label=""
						...
						>
							...
							<ToggleGroupControlOption
								...
								showTooltip={true}
								aria-label={__("Device (min. 768px - max. 1440px)", "epea-theme")}
							/>
							<ToggleGroupControlOption
								value="xl"
						...
						<TextControl
							className="block-mt"
							label={__("Image Alt - Text", "epea-theme")}
							type="text"
					...
					<PanelBody title={__("Additional", "epea-theme")} initialOpen={true}>
						<TextControl
						...
						/>
						<TextControl
							label={__("Class", "epea-theme")}
							placeholder={__("Specify class…", "epea-theme")}
							type="text"
							value={extraClass}
								...
								<div class="newsletter">
									...
									<div className="newsletter__content">
										<div className="nl--form--title">
											{__("„Stay in the loop“", "epea-theme")}
										</div>
										<div className="nl--form--info">
											{__("Sign up now for our newsletter", "epea-theme")}
										</div>
										<form
											id="newsletter__form"
											method="post"
										...
										>
											<div className="form--control feild--email">
												...
												<input
													type="email"
													className="field"
													data-label={__("Email", "epea-theme")}
													name="your-email"
													id="your-email"
											...
											<div className="form--control feild--acceptance">
												<input
													type="checkbox"
													className="field"
													data-label={__("Privacy", "epea-theme")}
													name="acceptance"
													id="acceptance"
													required
												/>
